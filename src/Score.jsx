...
export function ScoreBoard({ score, maxScore }) {
    ...
    return (
        <div className="bg-white/5 py-1 sm:py-4 mx-auto">
            <div className="mx-auto max-w-xl px-6 lg:px-8">
                <dl className="mx-auto grid grid-cols-1 gap-0.5 overflow-hidden rounded-2xl text-center sm:grid-cols-2 max-w-md">
                    <div className="flex flex-col bg-gray-400/5 p-2">
                        <dt className="text-sm leading-7 text-gray-600">Current Score</dt>
                        <dd className="order-first text-m font-semibold tracking-tight text-gray-900 sm:text-2xl">
                            {score}
                        </dd>
                    </div>
                    <div className="flex flex-col bg-gray-400/5 p-2">
                        <dt className="text-sm leading-7 text-gray-600">Best Score</dt>
                        <dd className="order-first text-m font-semibold tracking-tight text-gray-900 sm:text-2xl">
                            {maxScore}
                        </dd>
                    </div>
